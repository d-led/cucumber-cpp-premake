...
ifeq ($(config),debug32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/Debug/cucumber-cpp-boost-driver/x32
  TARGETDIR  = ../../../bin/macosx/gmake/x32/Debug
  TARGET     = $(TARGETDIR)/libcucumber-cpp-boost-driver.a
  DEFINES   += -DDEBUG -D_DEBUG -DBOOST_TEST_ALTERNATIVE_INIT_API
...
ifeq ($(config),release32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/Release/cucumber-cpp-boost-driver/x32
  TARGETDIR  = ../../../bin/macosx/gmake/x32/Release
  TARGET     = $(TARGETDIR)/libcucumber-cpp-boost-driver.a
  DEFINES   += -DRELEASE -DBOOST_TEST_ALTERNATIVE_INIT_API
  INCLUDES  += -I../../../googlemock/fused-src -I../../../cucumber-cpp/include -I../../../cppspec/include -I/usr/local/include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),native32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/native/cucumber-cpp-boost-driver/x32
  TARGETDIR  = ../../../bin/macosx/gmake
  TARGET     = $(TARGETDIR)/libcucumber-cpp-boost-driver.a
  DEFINES   += -DBOOST_TEST_ALTERNATIVE_INIT_API
  INCLUDES  += -I../../../googlemock/fused-src -I../../../cucumber-cpp/include -I../../../cppspec/include -I/usr/local/include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/Debug/cucumber-cpp-boost-driver/x64
...
ifeq ($(config),release64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/Release/cucumber-cpp-boost-driver/x64
...
ifeq ($(config),native64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/native/cucumber-cpp-boost-driver/x64
  TARGETDIR  = ../../../bin/macosx/gmake
  TARGET     = $(TARGETDIR)/libcucumber-cpp-boost-driver.a
  DEFINES   += -DBOOST_TEST_ALTERNATIVE_INIT_API
  INCLUDES  += -I../../../googlemock/fused-src -I../../../cucumber-cpp/include -I../../../cppspec/include -I/usr/local/include
