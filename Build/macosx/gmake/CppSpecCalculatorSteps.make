...
ifeq ($(config),debug32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/Debug/CppSpecCalculatorSteps/x32
  TARGETDIR  = ../../../bin/macosx/gmake/x32/Debug
  TARGET     = $(TARGETDIR)/CppSpecCalculatorSteps
  DEFINES   += -DDEBUG -D_DEBUG
  INCLUDES  += -I../../../googlemock/fused-src -I../../../cucumber-cpp/include -I../../../cppspec/include -I/usr/local/include -I../../../cucumber-cpp/examples/Calc/src
...
ifeq ($(config),release32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/Release/CppSpecCalculatorSteps/x32
...
ifeq ($(config),native32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/native/CppSpecCalculatorSteps/x32
  ...
  LDDEPS    += ../../../bin/macosx/gmake/libcucumber-cpp-main.a ../../../bin/macosx/gmake/libcucumber-cpp.a ../../../bin/macosx/gmake/libcppspec.a ../../../bin/macosx/gmake/libcucumber-cpp-cppspec-driver.a
  LIBS      += $(LDDEPS) -lboost_system-mt -lboost_regex-mt -lboost_chrono-mt -lboost_thread-mt
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),debug64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/Debug/CppSpecCalculatorSteps/x64
...
ifeq ($(config),release64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/Release/CppSpecCalculatorSteps/x64
...
ifeq ($(config),native64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/native/CppSpecCalculatorSteps/x64
  TARGETDIR  = ../../../bin/macosx/gmake
  TARGET     = $(TARGETDIR)/CppSpecCalculatorSteps
  DEFINES   +=
  INCLUDES  += -I../../../googlemock/fused-src -I../../../cucumber-cpp/include -I../../../cppspec/include -I/usr/local/include -I../../../cucumber-cpp/examples/Calc/src
