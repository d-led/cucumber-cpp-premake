...
ifeq ($(config),debug32)
  OBJDIR     = ../../../obj/linux/gmake/x32/Debug/gmock-test/x32
  TARGETDIR  = ../../../bin/linux/gmake/x32/Debug
  TARGET     = $(TARGETDIR)/gmock-test
  DEFINES   += -DDEBUG -D_DEBUG
  INCLUDES  += -I../../../googlemock/fused-src -I../../../cucumber-cpp/include -I../../../cppspec/include -I../../../googlemock -I../../../googlemock/include -I../../../googlemock/gtest/include
  ...
  LDDEPS    += ../../../bin/linux/gmake/x32/Debug/libgooglemock.a
...
ifeq ($(config),release32)
  OBJDIR     = ../../../obj/linux/gmake/x32/Release/gmock-test/x32
  ...
  LDDEPS    += ../../../bin/linux/gmake/x32/Release/libgooglemock.a
  LIBS      += $(LDDEPS) -lpthread
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),native32)
  OBJDIR     = ../../../obj/linux/gmake/x32/native/gmock-test/x32
  ...
  LDDEPS    += ../../../bin/linux/gmake/libgooglemock.a
  LIBS      += $(LDDEPS) -lpthread
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),debug64)
  OBJDIR     = ../../../obj/linux/gmake/x64/Debug/gmock-test/x64
  ...
  LDDEPS    += ../../../bin/linux/gmake/x64/Debug/libgooglemock.a
  LIBS      += $(LDDEPS) -lpthread
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),release64)
  OBJDIR     = ../../../obj/linux/gmake/x64/Release/gmock-test/x64
  ...
  LDDEPS    += ../../../bin/linux/gmake/x64/Release/libgooglemock.a
  LIBS      += $(LDDEPS) -lpthread
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),native64)
  OBJDIR     = ../../../obj/linux/gmake/x64/native/gmock-test/x64
  TARGETDIR  = ../../../bin/linux/gmake
  TARGET     = $(TARGETDIR)/gmock-test
  DEFINES   +=
  INCLUDES  += -I../../../googlemock/fused-src -I../../../cucumber-cpp/include -I../../../cppspec/include -I../../../googlemock -I../../../googlemock/include -I../../../googlemock/gtest/include
